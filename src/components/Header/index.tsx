    ...
    <div className="header">
      <div className="header-first">
        <div className="header-first__contact-number">
          <p className="header-first__contact-number--text">
            <img src={Logo} alt="logo" />
          </p>
        </div>
        <div className="header-first__user-details">
          <p className="header-first__contact-number--text">
            <PhoneOutlined /> {HEADER_CONTACT_NUMBER} - <MailOutlined />{" "}
            {HEADER_CONTACT_EMAIL}{" "}
          </p>

          {true ? (
            <p
              className="header-first__user-details--text"
              onClick={handleLogout}
            >
              {localUserData?.email} /<b> {LOGOUT_TEXT}</b>
            </p>
          ) : (
            <p
              className="header-first__user-details--text"
