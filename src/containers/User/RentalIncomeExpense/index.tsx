...
function RentalIncomeExpense() {
    ...
    const onSubmitRentalIncome = () => {
        ...
        //dispatch(addRentalIncomes({ rentalIncomeExpenses: modifiedData }, localStoreData.leadId))
        dispatch(addRentalIncomes({ rentalIncomeExpenses: modifiedData }, leadId))
    }
                ...
                <>
                  ...
                  <div>
                    ...
                    <Row justify={'end'}>
                        <Col>
                            <Form.Item>
                                <Button type="primary" htmlType="submit" onClick={onSubmitRentalIncome}>
                                    Submit
                                </Button>
                            </Form.Item>
                        </Col>
