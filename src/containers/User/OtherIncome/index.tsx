...
function OtherIncome() {
  ...
  const onSubmitOtherIncome = (values: any, isAutoSave = false) => {
    ...
    keys.forEach((key: any) => {
      ...
      if (
        !isNaN(Number(copyValues[key])) &&
        !["others", "others2", "others3"].includes(key)
      ) {
  ...
  const formFields: any = [
    ...
    },
    {
      ...
      config: {
        rules: [
          { required: false, message: "Please Enter State Income tax refund" },
        ],
      },
    },
    {
      ...
      config: {
        rules: [
          {
            required: false,
            message: "Please Enter Gambling Lottery winnings",
          },
        ],
      },
    },
  ...
  const others = [
    ...
    },
    {
      ...
      config: {
        rules: [
          { required: false, message: "Please Enter Tax Paid / Withheld" },
        ],
      },
    },
  ];
      ...
      {isleadDetailsLoading ? (
        ...
        <>
          ...
          >
            <div>
              <p>
                <strong>Note : </strong>In the year 2023, did you or your spouse
                win cash or prizes through lotteries or gambling? The term
                Gambling encompasses a variety of activities, such as horse and
                dog racing, lotteries, raffles and any other game involving
                chance.
              </p>
              <hr />
            </div>
