...
function SelfEmployment() {
    ...
    const onChangeEmployment = (value: string, name: string, index: number) => {
     ...
     const onSubmitSelfEmployment = () => {
        ...
        //dispatch(addSelfEmployment({ selfEmploymentInfo: modifiedData }, localStoreData.leadId))
        dispatch(addSelfEmployment({ selfEmploymentInfo: modifiedData }, leadId))
    }
                ...
                <>
                  ...
                  <div>
                    ...
                    <Row justify={'end'}>
                        <Col>
                            <Form.Item>
                                <Button type="primary" htmlType="submit" onClick={onSubmitSelfEmployment}>
                                    Submit
                                </Button>
                            </Form.Item>
                        </Col>
