...
function Documents() {
    ...
    return [
      {
        ...
        config: {
          rules: [
            {
              required: false,
              message: "Please Enter Wage & Salary Income-Form W-2s",
            },
          ],
        },
      },
      {
        ...
        type: "file",
        placeholder:
          "Enter Pensions, Annuities, Profit Sharing, IRA's, -Form(s) 1099-R",
        config: {
          rules: [
            {
              required: false,
              message:
                "Please Enter Pensions, Annuities, Profit Sharing, IRA's, -Form(s) 1099-R",
            },
          ],
        },
      },
      {
        ...
        onChangeField: onChangeDocuments,
        value:
          typeof socialSecuritySsa1099 === "string"
            ? socialSecuritySsa1099
            : "",
        required: true,
        disable: false,
        type: "file",
        placeholder:
          "Enter Social Security/Railroad Benefits- Form(s) SSA-1099",
        config: {
          rules: [
            {
              required: false,
              message:
                "Please Enter Social Security/Railroad Benefits- Form(s) SSA-1099",
            },
          ],
        },
      },
      {
        ...
        onChangeField: onChangeDocuments,
        value:
          typeof interestIncome1099Int === "string"
            ? interestIncome1099Int
            : "",
        required: true,
        disable: false,
        type: "file",
        placeholder:
          "Enter Interest Income- Form(s) 1099-INT & Broker statements",
        config: {
          rules: [
            {
              required: false,
              message:
                "Please Enter Interest Income- Form(s) 1099-INT & Broker statements",
            },
          ],
        },
      },
      {
        ...
        config: {
          rules: [
            {
              required: false,
              message: "Please Enter Partnership, Trust, Estate- Form(s) K-1",
            },
          ],
        },
      },
      ...
      },
      {
        ...
        onChangeField: onChangeDocuments,
        value:
          typeof investmentSold1099B === "string" ? investmentSold1099B : "",
        required: true,
        disable: false,
        type: "file",
        ...
        config: {
          rules: [
            {
              required: false,
              message: "Please Enter Investments Sold- Form(s) 1099-B",
            },
          ],
        },
      },
      {
        ...
        config: {
          rules: [
            {
              required: false,
              message: "Please Enter Property Sold- Form(s) 1099-S",
            },
          ],
        },
      },
  ...
  const onSubmitTaxFile = (isAutoSave = false) => {
  ...
  }, [documents, selectedMultipleFiles]);
  ...
  const handleFormChange = () => {
    ...
    autoSaveTimerRef.current = setTimeout(() => {
      ...
      // 🔧 Wait a tick so that setState values are reflected
      setTimeout(() => {
        ...
        onSubmitTaxFile(true);
      }, 0); // micro delay to wait for state
    }, 2000);
  };
  ...
  useEffect(() => {
    if (
      ...
      if (
        ...
        Object.keys(leadDocuments[0]).length > 0 &&
        leadDocuments
      ) {
        const {
          ...
          >
            ...
            <Row gutter={gutterBlobal}>
              {selectedMultipleFiles.length > 0 &&
                selectedMultipleFiles.map((singleFile: any, i: number) => (
                  <Col className="gutter-row" xl={12} sm={12} xs={24}>
                    <Form.Item>
                      <div
                        className="multiple-file"
                        style={{
                          display: "flex",
              ...
              {createdMultipleFiles.length > 0 &&
                createdMultipleFiles.map((singleFile: any, i: number) => (
                  <Col className="gutter-row" xl={12} sm={12} xs={24}>
                    <Form.Item>
                      <div
                      ...
                      >
                        ...
                        >
                          {singleFile.split("/").pop().replace(/%20/g, "") ||
                            "Tax file"}
                        </p>{" "}
                        {/* Show the filename */}
                      </div>
            ...
            <Row>
              <Col className="gutter-row" xl={24} sm={24} xs={24}>
                <Form.Item>
                  <p>
                    <strong>Note</strong> :{" "}
                    {leadData?.leadDocumentsComment
                      ? leadData?.leadDocumentsComment
                      : ""}
                  </p>
                  <TextArea
                    onChange={(e: any) => setNoteValues(e.target.value)}
                    placeholder="Enter Selected Notes"
                  />
                </Form.Item>
