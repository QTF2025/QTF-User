...
function EstimatedTaxPayments() {
    ...
    const onSubmitEstimatedTaxPayer = () => {
        ...
        //dispatch(addEstimatedTaxPayer({ estimatedTaxPayments: modifiedData }, localStoreData.leadId))
        dispatch(addEstimatedTaxPayer({ estimatedTaxPayments: modifiedData }, leadId))
    }
                ...
                <>
                  ...
                  <div>
                    ...
                    <Row justify={'end'}>
                        <Col>
                            <Form.Item>
                                <Button type="primary" htmlType="submit" onClick={onSubmitEstimatedTaxPayer}>
                                    Submit
                                </Button>
                            </Form.Item>
                        </Col>
