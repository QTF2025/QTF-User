...
import Icon, { CustomerServiceOutlined, UsergroupAddOutlined } from '@ant-design/icons';
...
import './styles.scss'
import { getComments, getReviews, initGetLead } from '../../store/actions/creators';
...
const Dashboard = () => {
    ...
    useEffect(() => {
        if(localStoreData){
            if(localStoreData.leadId === "" || localStorage.getItem("newapplication")){
                navigate('/user')
            }else{
      ...
      <div className="dashboard">
        ...
        <div className="dashboard__header">
          ...
          <div className='dashboard__header--reopen'>
                    <p style={{cursor:"pointer"}} onClick={newApplication}>New Application</p>
                </div>
        </div>
        <hr />
        <TaxesList />
        ...
        <div className="dashboard__title">
          <p>
            ...
            <span onClick={() => navigate(`/user?lead_id=${localStoreData.leadId}`)}>
              Click here to find your application
            </span>
          </p>
          <div>
          <Space onClick={toggleReferealModal}>
            <UsergroupAddOutlined size={40} style={{ color: "red", fontSize: "24px" }} />
            <span>Referral</span>
            </Space>
